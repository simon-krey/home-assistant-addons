...
| **Needle 3 Conversation** | `needle_agent` | Conversation-Agent (Wyoming `handle`) mit wählbarem Backend: **Needle 3**, **OpenAI-kompatible LLMs** (Ollama/llama.cpp/LM Studio/OpenRouter) oder **Home Assists Agent** – mit Tool-Calling, Grounding-Prüfung, HA-Fallback, Web-UI und Verlauf |
